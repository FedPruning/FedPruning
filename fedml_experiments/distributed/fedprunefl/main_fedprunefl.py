...
from fedml_api.distributed.fedprunefl.FedPruneflAPI import FedML_init, FedML_FedPrunefl_distributed
...
if __name__ == "__main__":
    ...
    str_process_name = "FedPrunefl (distributed):" + str(process_id)
    ...
    # In this case, please use our FedML distributed version (./fedml_experiments/distributed_fedprune)
