...
from fedml_api.standalone.feddp.feddp_api import FedDpAPI
from fedml_api.standalone.feddp.my_model_trainer_classification import MyModelTrainer as MyModelTrainerCLS
...
if __name__ == "__main__":
    ...
    model=SparseModel(inner_model, target_density=0.5, str="uniform_random")
