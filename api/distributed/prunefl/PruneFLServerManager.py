...
class PruneFLServerManager(ServerManager):
    ...
    def send_init_msg(self):
        ...
        if self.args.is_mobile == 1:  # true
            global_model_params = transform_tensor_to_list(global_model_params)  # 转为list
    ...
    def handle_message_receive_model_from_client(self, msg_params):
        ...
        if self.mode in [2, 3]:
            ...
            self.aggregator.add_local_trained_gradient_squared(sender_id - 1, gradient_squared)
