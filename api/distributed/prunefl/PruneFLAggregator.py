...
class PruneFLAggregator(object):
    ...
    def __init__(self, train_global, test_global, all_train_data_num,
        ...
        self.gradient_squared_dict = dict()  # Store the squared gradient uploaded by each client
        # self.gradient_dict = dict()
        self.sample_num_dict = dict()  # Store the number of train data for each client
    ...
    def add_local_trained_gradient_squared(self, index, gradient_squared):
        logging.info("add_gradient_squared. index = %d" % index)
