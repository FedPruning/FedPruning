...
from api.distributed.feddorefa.FedDorefaAPI import FedML_init, FedDorefa_distributed
...
if __name__ == "__main__":
    ...
    str_process_name = "FedDorefa (distributed):" + str(process_id)
    ...
    # In this case, please use our FedML distributed version (./experiments/distributed_feddorefa)
    model = create_model(args, model_name=args.model, output_dim=dataset[7])

    # start distributed training
    FedDorefa_distributed(
        process_id,
        worker_number,
        device,
        comm,
