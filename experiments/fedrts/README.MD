...
```
# general test 
CUDA_VISIBLE_DEVICES=0,1,2,3 sh run_fedrts_distributed_pytorch.sh resnet18 cifar10 100 10 500 5 0.2 0.001 --delta_T 10 --partition_alpha 0.5 --adjust_alpha 0.2

# quick test 
CUDA_VISIBLE_DEVICES=4,5,6,7 sh run_fedrts_distributed_pytorch.sh resnet18 cifar10 100 10 500 5 0.1 0.001 --delta_T 10 --T_end 300 --num_eval 128 --frequency_of_the_test 10 --enable_adaptive_aggregation 0 --adaptive_beta 0.1 --enable_ts 1 --aggregated_gamma 0.5 --initial_distribution_ratio 1.0 --client_optimizer adam 
...
```
CUDA_VISIBLE_DEVICES=[gpus] sh run_fedrts_distributed_pytorch.sh [model] [dataset] [client_num_in_total] [client_num_per_round]  [comm_round] [epochs] [target_density] [initial_lr]   {--delta_T , --T_end, --partition_alpha, --num_eval, --frequency_of_the_test, --enable_adaptive_aggregation, --adaptive_beta, --enable_ts, --aggregated_gamma, --initial_distribution_ratio, --ts_beta_update}
```
